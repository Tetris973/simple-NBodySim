import { loadNBodyFromJSON } from '#src/services/nbodyLoader'
import { nBodyVerlet } from '#src/engine/tasksLogic/simulationTasks/forces/nBodyVerlet'

describe('nBodyVerlet Tests', () => {
  let nBodies

  beforeEach(async () => {
    nBodies = await loadNBodyFromJSON('./data/planetsConfig.json')
  })
